...
export const NewsUpdateModal = ({opened, onClose, news}: ModalProps) => {
    ...
    return (
        <Modal title="Обновление новости" opened={opened} onClose={onClose} centered>
